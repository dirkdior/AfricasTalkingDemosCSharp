...
public class AfricasTalkingGatewayFileException : Exception
{
    public AfricasTalkingGatewayFileException(string message)
            : base(message) { }
    public AfricasTalkingGatewayFileException(Exception ex) : base(ex.Message, ex)
    {

    }
}
public class AfricasTalkingGatewayFile
{
    ...
    public AfricasTalkingGatewayFile(string username_, string apiKey_)
    {
        _username = username_;
        _apiKey = apiKey_;
    ...
    public AfricasTalkingGatewayFile(string username, string apiKey, string environment)
    {
        _username = username;
        _apiKey = apiKey;
    ...
    {       
        ...
        if (responseCode == (int)HttpStatusCode.Created) {
            ...
            throw new AfricasTalkingGatewayFileException(json ["SMSMessageData"] ["Message"]);
        }
        throw new AfricasTalkingGatewayFileException(response);
    }
    ...
    public dynamic createSubscription(string phoneNumber_, string shortCode_, string keyword_) 
    {
        if(phoneNumber_.Length == 0 || shortCode_.Length == 0 || keyword_.Length == 0)
            throw new AfricasTalkingGatewayFileException("Please supply phone number, short code and keyword");
    ...
    public dynamic call (string from_, string to_)
    {
        ...
        throw new AfricasTalkingGatewayFileException (json ["errorMessage"]);
    }
    ...
    private string sendPostRequest (Hashtable dataMap_, string urlString_)
    {
        try {
            ...
            if(ex.Response == null)
                throw new AfricasTalkingGatewayFileException(ex.Message);
        ...
        catch(AfricasTalkingGatewayFileException ex) {
            throw ex;
        }
    }
    ...
    public dynamic initiateMobilePaymentCheckout(string productName_, string phoneNumber_, string currencyCode_, int amount_, string providerChannel_)
    {
        ...
        {
            throw new AfricasTalkingGatewayFileException(ex);
        }
    }
